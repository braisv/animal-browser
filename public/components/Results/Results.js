...
const Results = () => {
  ...
  return react_1.default.createElement(
    ...
    { className: "results" },
    listItems.length
      ? react_1.default.createElement("ul", null, listItems.map(ListItem_1.default))
      : react_1.default.createElement(NoResult_1.default, null),
    selectedItem && react_1.default.createElement(SelectedItem_1.default, { animalItem: selectedItem })
  );
};
